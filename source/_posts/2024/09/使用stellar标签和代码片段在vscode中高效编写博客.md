...
```json
{
	"Emoji Tag": {
		"prefix": "emoji",
		"body": [
			"{% emoji ${1:source} ${2:name} ${3:height:1.75em} %}"
		],
	...
	"Hashtag Tag": {
		"prefix": "hashtag",
		"body": [
			"{% hashtag ${1:text} ${2:url} ${3:color:default} %}"
		],
	...
	"Note Tag": {
		"prefix": "note",
		"body": [
			"{% note ${1:title} ${2:内容} ${3:color:yellow} %}"
		],
	...
	"Link Tag": {
		"prefix": "link",
		"body": [
			"{% link ${1:href} ${2:title} ${3:icon:src} %}"
		],
	...
	"Audio Tag": {
		"prefix": "audio",
		"body": [
			"{% audio type:${1:2} netease:${2:1856385686} autoplay:${3:0} %}"
		],
	...
	"Navbar": {
		"prefix": "navbar",
		"body": [
			"{% navbar active:${1:/wiki/} ${2:[文章](/)} ${3:[项目](/wiki/)} ${4:[留言](#comments)} ${5:[GitHub](https://github.com/struggle-upwards)} %}"
		],
	...
	"Render Markdown": {
		"prefix": "md",
		"body": [
			"{% md ${1:https://cdn.jsdmirror.com/gh/struggle-upwards/AIContentSummaryCuteen/README.md} %}"
		],
	...
	"GHCard": {
		"prefix": "ghcard",
		"body": [
			"{% ghcard ${1:struggle-upwards} %}",
			"{% ghcard ${2:struggle-upwards/blog} %}"
		],
	...
	"TOC": {
		"prefix": "toc",
		"body": [
			"{% toc wiki:${1:xxx} [open:${2:true}] ${3:title} %}"
		],
